            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="{{url('admin/category/'.$category->cate_id)}}" class="form-horizontal m-t" id="commentForm">
                            {{csrf_field()}}
                            <input type="hidden" name="_method" value="put">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">分类名称：</label>
                                <div class="col-sm-8">
                                    <input  name="cate_name" value="{{$category['cate_name']}}" minlength="2" type="text" class="form-control" required="" aria-required="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input  name="cate_title" value="{{$category['cate_title']}}" minlength="2" type="text" class="form-control" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="cate_pid" class="form-control">
                                        ...
                                        @foreach($data as $k=>$v)
                                            <option @if($category['cate_pid']==$v['cate_id']) selected @endif value="{{$v['cate_id']}}">{{$v['cate_name']}}</option>
                                            @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input  name="cate_keywords" value="{{$category['cate_keywords']}}" type="text" class="form-control"  aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">分类描述：</label>
                                <div class="col-sm-8">
                                    <textarea  name="cate_descrition" class="form-control" aria-required="true">{{$category['cate_descrition']}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">排序：</label>
                                <div class="col-sm-1">
                                    <input name="cate_sort" value="{{$category['cate_sort']}}" minlength="1" maxlength="3" type="text" class="form-control" aria-required="true">
                                </div>
                            </div>
