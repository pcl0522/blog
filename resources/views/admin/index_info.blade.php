    ...
    @section('css')
    <!-- Morris -->
    <link href="{{asset('')}}resources/admin/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    <!-- Gritter -->
    <link href="{{asset('')}}resources/admin/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
    @endsection
                        ...
                        <div class="feed-activity-list">
                            ...
                            <div class="feed-element">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{asset('')}}resources/admin/img/profile.jpg">
                                </a>
                            ...
                            <div class="feed-element">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{asset('')}}resources/admin/img/a2.jpg">
                                </a>
                                <div class="media-body ">
                            ...
                            <div class="feed-element">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{asset('')}}resources/admin/img/a3.jpg">
                                </a>
                                <div class="media-body ">
                            ...
                            <div class="feed-element">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{asset('')}}resources/admin/img/a5.jpg">
                                </a>
                                <div class="media-body ">
...
<script src="{{asset('')}}resources/admin/js/plugins/flot/jquery.flot.js"></script>
<script src="{{asset('')}}resources/admin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="{{asset('')}}resources/admin/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="{{asset('')}}resources/admin/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="{{asset('')}}resources/admin/js/plugins/flot/jquery.flot.pie.js"></script>
...
<script src="{{asset('')}}resources/admin/js/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="{{asset('')}}resources/admin/js/plugins/gritter/jquery.gritter.min.js"></script>
<script src="{{asset('')}}resources/admin/js/plugins/easypiechart/jquery.easypiechart.js"></script>
<script src="{{asset('')}}resources/admin/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<script src="{{asset('')}}resources/admin/js/demo/sparkline-demo.min.js"></script>
<script>
