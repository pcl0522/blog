            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="{{url('admin/article')}}" class="form-horizontal m-t" id="commentForm" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><b style="color: red">*</b>标题：</label>
                                <div class="col-sm-8">
                                    <input  name="art_title" minlength="2" type="text" class="form-control" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input  name="art_editor" minlength="2" type="text" class="form-control" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input  name="art_tag" minlength="2" type="text" class="form-control" aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="ccomment" name="art_description" class="form-control" aria-required="true"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <script type="text/plain" id="myEditor" name="art_content" style="width:100%;height:320px;"></script>
