            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="{{url('admin/links')}}" class="form-horizontal m-t" id="commentForm">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label class="col-sm-3 control-label">名称：</label>
                                <div class="col-sm-8">
                                    <input  name="link_name" minlength="2" type="text" class="form-control" required="" aria-required="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input  name="link_title" minlength="2" type="text" class="form-control" aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input  name="link_url"  type="text" class="form-control"  aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input  name="link_sort" minlength="1" maxlength="3" type="text" class="form-control" aria-required="true">
                                </div>
                            </div>
