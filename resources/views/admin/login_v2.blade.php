...
<head>
    ...
    <link href="{{asset('resources/views/admin/css/font-awesome.min93e3.css?v=4.4.0')}}" rel="stylesheet">
    <link href="{{asset('')}}resources/views/admin/css/animate.min.css" rel="stylesheet">
    <link href="{{asset('')}}resources/views/admin/css/style.min.css" rel="stylesheet">
    <link href="{{asset('')}}resources/views/admin/css/login.min.css" rel="stylesheet">
    <!--[if lt IE 9]>
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post" action="http://www.zi-han.net/theme/hplus/index.html">
                    ...
                    <input type="text" class="form-control code m-b" placeholder="验证码" />
                    <a href="#">忘记密码了？</a>
