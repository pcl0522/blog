            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="{{url('admin/navs/'.$nav->nav_id)}}" class="form-horizontal m-t" id="commentForm">
                            {{csrf_field()}}
                            <input type="hidden" name="_method" value="put">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">名称：</label>
                                <div class="col-sm-8">
                                    <input  name="nav_name" value="{{$nav->nav_name}}" minlength="2" type="text" class="form-control" required="" aria-required="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input  name="nav_alias" value="{{$nav->nav_alias}}"  minlength="2" type="text" class="form-control" aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input  name="nav_url" value="{{$nav->nav_url}}"  type="text" class="form-control"  aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input  name="nav_sort"  value="{{$nav->nav_sort}}" minlength="1" maxlength="3" type="text" class="form-control" aria-required="true">
                                </div>
                            </div>
